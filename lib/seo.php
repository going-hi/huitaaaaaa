...
function mb_seo_landing_json_ld(string $pageUrl, array $faqItems): array
{
    ...
    return [
        [
            ...
            'description' => 'MindBase — бесплатная платформа корпоративной wiki и базы знаний: Markdown-статьи, полнотекстовый поиск, роли, документы и обучение. Без тарифов и лимитов — альтернатива Notion и Confluence.',
            'inLanguage' => 'ru-RU',
        ...
        [
            ...
            'description' => 'Разработчик бесплатной платформы корпоративной базы знаний MindBase. Wiki, документы, обучение и управление знаниями для команд любого размера — без тарифов и ограничений.',
            'sameAs' => [],
        ],
        [
            '@type' => 'WebSite',
            ...
            'url' => $pageUrl,
            'name' => 'MindBase',
            'description' => 'Бесплатная корпоративная wiki и база знаний для бизнеса: статьи, поиск, роли, документы, обучение. Альтернатива Notion и Confluence без лимитов.',
            'inLanguage' => 'ru-RU',
            'publisher' => ['@id' => $orgId],
        ],
        [
            ...
            'operatingSystem' => 'Web',
            'url' => $pageUrl,
            'description' => 'Корпоративная wiki и база знаний: Markdown-статьи, иерархия разделов, полнотекстовый поиск, группы доступа, файловый реестр, курсы обучения с прогрессом, экспорт в Markdown/HTML. Бесплатная альтернатива Notion и Confluence.',
